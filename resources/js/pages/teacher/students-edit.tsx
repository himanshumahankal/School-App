...
export default function StudentsEdit() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.put(`/teacher/students/${student.id}`, formData, {
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="mt-1 text-slate-400">Update student information</p>
                    </div>
                </div>
                    ...
                    <div className="rounded-2xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-sm p-6 space-y-6">
                        ...
                        <div className="flex items-center justify-end gap-4 pt-4">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-2.5 rounded-xl text-white font-medium disabled:opacity-50"
                            >
