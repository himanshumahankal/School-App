...
export default function EditStudent({ user, classes }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        school_class_id: user.student_profile?.school_class_id?.toString() || '',
    });
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 flex justify-center">
                <div className="w-full max-w-2xl bg-white dark:bg-zinc-900 border rounded-xl shadow-sm p-6">
                    <h1 className="text-2xl font-bold mb-6">Edit Student: {user.name}</h1>
