...
export default function CreateParent() {
    const { availableStudents } = usePage<PageProps>().props;
        ...
        <AppLayout>
            ...
            <div className="mx-auto min-h-screen max-w-5xl bg-slate-900 p-6">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white">Add New Parent</h1>
                    <p className="mt-1 text-slate-400">Fill in the details to add a new parent</p>
                </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-slate-700 bg-slate-800">
                    ...
                    >
                                ...
                                <div className="space-y-2">
                                    <label className="block text-sm font-medium text-slate-300">
                                        ...
                                        {availableStudents.length === 0 && (
                                            <span className="ml-2 text-xs text-amber-400">(All students have parents)</span>
                                        )}
                                    </label>
                                    <select
                        ...
                        <div className="flex justify-end gap-3 border-t border-slate-700 bg-slate-900 px-8 py-6">
                            ...
                            <button
                                type="submit"
                                disabled={processing || availableStudents.length === 0}
